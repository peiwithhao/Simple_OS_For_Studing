...
![](http://imgsrc.baidu.com/super/pic/item/060828381f30e924b9287cf509086e061c95f762.jpg)
然后我们进入保护模式之前，我偶们可以使用`info gdt`命令来查看我们自己构建的gdt表，如下图,这里也看到确实有咱们构造的三个段描述符，
![](http://imgsrc.baidu.com/super/pic/item/f11f3a292df5e0fee79d69c5196034a85fdf7269.jpg)
在我们进入保护模式之后，我们再次使用命令`creg`来查看CR0寄存器的值，这里可以看到PE大写了，
![](http://imgsrc.baidu.com/super/pic/item/eaf81a4c510fd9f9e396b5ad602dd42a2934a475.jpg)
然后我们查看虚拟机确实有我们在保护模式下输出的P字符，当然也有咱们在实模式下输出的‘I am loader in real’
![](http://imgsrc.baidu.com/super/pic/item/eac4b74543a982262a3ecbe3cf82b9014b90eb7c.jpg)
...
![](http://imgsrc.baidu.com/super/pic/item/58ee3d6d55fbb2fb5ff5b8d60a4a20a44723dc1c.jpg)
...
![](http://imgsrc.baidu.com/super/pic/item/0d338744ebf81a4c60ce0f0d922a6059242da672.jpg)
